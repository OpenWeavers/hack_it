...
<head>
    ...
    <script>
        ...
        function viewDB() {
            window.location.href = 'db_view.php';
        }
    </script>
</head>
<body>
...
<div class="row" id="ques">
    <form class="col s6" action="answer_verification.php" method="post">
        ...
        <div class="row">
            <p><h6>We have given you the database. Now, give us the clear password:</h6></p>
        ...
        <br>
        <br>
        <button class="btn waves-effect waves-light" type="button" onclick="viewDB()">View DB</button>
        <div class="col s12">
